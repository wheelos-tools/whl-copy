"""Unit tests for filtering policy engine."""
import datetime
import pytest
...
def test_build_filter_args_combined():
    args = FilterEngine.build_filter_args({"min_size": "1m", "newer_than": 30})
